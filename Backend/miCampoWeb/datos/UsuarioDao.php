    ...
    public static function registrar($usuario){
      ...
      public static function eliminarUsuario($usuario_id){
        ...
        public static function getUsuarios(){
            ...
            $query = "SELECT 
            usuario_id,nombre,apellido,correo,telefono,fecha_registro,privilegio_id 
            FROM usuario order by apellido ASC";
      ...
      //Metodo que sirve para crear nuevos usuarios y modificar uno existentes
